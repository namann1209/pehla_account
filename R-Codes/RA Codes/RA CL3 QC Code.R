...
err_loc <- "H:\\01. GIP BAI\\MBR\\Automation\\Automation\\RA\\CL3_Nation\\Error_Files"
...
for(i in 1:nfile)
{
  ...
  if (i <= hfile)
  {
    ...
    b <- b[,c("Terr.Nm","Reach.Change..", "Reach.Change.Shape", "Reach" ,"Cpay.Drops.C" ,"Sum.of.Tcl.Hcps")]
  ...
  else
  {
    ...
    b <- b[,c("Terr.Nm","Open.Rate", "Reach", "Cpay.Drops.C" ,"Mails.Opened" ,"Sum.of.Tcl.Hcps")]
