...
dpv <- ""
dpv[1]<- "H:\\01. GIP BAI\\MBR\\Automation\\Automation\\POA\\CL3_Nation"
dpv[2]<- "H:\\01. GIP BAI\\MBR\\Automation\\Automation\\POA\\CL3_RM"
...
for ( i in 1:2)   
{
      ...
      ch=read.xlsx("Print_to_Excel_POA.xlsx",sheetName = sheet_nm[i], stringsAsFactors = F)
